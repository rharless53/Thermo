...
[T,Vals,~,~] = dT_Optimizer(298,1300,0.1,cp0,h0,u0,s0);
% h0_air = h0(TK);         % [kJ/kg]
% [h0_T,h0_vals,~,~] = dT_Optimizer(298,1300,h0,0.1);
% % u0_air = u0(TK);         % [kJ/kg]
% [u0_T,u0_vals,~,~] = dT_Optimizer(298,1300,u0,0.1);
% % s0_air = s0(TK);         % [kJ/kg-K]
% [s0_T,s0_vals,diff,~] = dT_Optimizer(298,1300,s0,0.1);
